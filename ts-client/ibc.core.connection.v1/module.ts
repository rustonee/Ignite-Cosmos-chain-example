...
export { MsgUpdateParams, QueryConnectionRequest, GenesisState, MsgConnectionOpenInit, QueryClientConnectionsResponse, QueryConnectionParamsResponse, QueryConnectionClientStateResponse, QueryConnectionParamsRequest, IdentifiedConnection, QueryConnectionsResponse, QueryClientConnectionsRequest, QueryConnectionClientStateRequest, MsgConnectionOpenTryResponse, MsgConnectionOpenTry, Params, QueryConnectionsRequest, MsgConnectionOpenInitResponse, MsgUpdateParamsResponse, ConnectionEnd, Counterparty, ConnectionPaths, MsgConnectionOpenAckResponse, MsgConnectionOpenAck, MsgConnectionOpenConfirm, QueryConnectionResponse, QueryConnectionConsensusStateResponse, MsgConnectionOpenConfirmResponse, QueryConnectionConsensusStateRequest, Version, ClientPaths };
