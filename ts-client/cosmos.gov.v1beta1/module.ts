...
export { QueryProposalRequest, QueryProposalsResponse, QueryDepositsResponse, VotingParams, QueryParamsResponse, QueryDepositResponse, MsgVoteWeighted, MsgVoteWeightedResponse, MsgDeposit, WeightedVoteOption, DepositParams, QueryProposalsRequest, QueryVoteResponse, QueryVotesResponse, Vote, QueryProposalResponse, QueryDepositRequest, QueryTallyResultRequest, MsgVoteResponse, TallyParams, QueryVotesRequest, GenesisState, Proposal, TallyResult, Deposit, MsgSubmitProposal, MsgSubmitProposalResponse, MsgDepositResponse, TextProposal, QueryDepositsRequest, QueryTallyResultResponse, MsgVote, QueryVoteRequest, QueryParamsRequest };
